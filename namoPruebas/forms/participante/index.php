...
<html>
	...
	<body class="is-preload">
		...
		<!-- Wrapper -->
			...
			<div class="center gtr-uniform"><!--Formulario-->
			<tread>
			<tr><td><h2>Participantes </h2></td></tr>
			<table><?php mostrarParticipantes();?></table>
			</tread>
			</div>
			</section>
</div>
...
<?php
  ...
  function mostrarTipoPersona() {
      ...
      $query="SELECT * FROM tip_persona WHERE tp_detalle='Participante'";
      $res=mysqli_query($conexion,$query) or die(mysql_error());
        while($rows = mysqli_fetch_array($res)):
