...
--
-- Host: 127.0.0.1:3306
-- Generation Time: Sep 23, 2019 at 01:03 AM
...
INSERT INTO `actividad` (`act_codigo`, `act_fecha`, `edi_codigo`, `act_lugar`, `act_direccion`) VALUES
(1, '2019-09-20', 5, 'FPUNA', 'Test');
...
CREATE TABLE `funcion` (
  ...
  `fun_detalle` varchar(20) COLLATE utf8mb4_unicode_ci NOT NULL,
...
(2, 'Fotografía ', 'En esta edición todos los archivos (fotos/videos) serán entregados a Gabo antse de las 11');
...
(43, 'Eduardo David', 'Gomez Cardenas', 4659580, '0000', 'eduardocardenas97@gmail.com', NULL, '2000-03-18', 1, 3, 1),
(44, 'Giannina Arami', 'Iriarte Argaña    ', 5294121, '0000', 'gianniarami@hotmail.com', NULL, '0000-00-00', 2, 3, 1),
...
(168, 'Hector Ruben', 'Garcia', 4920159, '0000', '', NULL, '0000-00-00', 1, 1, 1),
...
(171, 'Makarena Inés', 'Giménez Lird', 5715794, '0000', '', NULL, '0000-00-00', 2, 1, 15),
(172, 'Melinda', 'Gimenez', 5663687, '0000', '', NULL, '0000-00-00', 2, 1, 1),
...
(175, 'Federico David', 'Gómez Molinas', 3815875, '0000', '', NULL, '0000-00-00', 1, 1, 11),
(176, 'Pedro Manuel', 'Gómez Monzón', 4351139, '0000', '', NULL, '0000-00-00', 1, 1, 14),
(177, 'Joel Nicolás', 'Gómez Torres', 5374905, '0000', '', NULL, '0000-00-00', 1, 1, 13),
(178, 'Aldo', 'Gónzalez Colmán', 5005898, '0000', '', NULL, '0000-00-00', 1, 1, 1),
(179, 'Hector Osmar', 'González García', 4687964, '0000', '', NULL, '0000-00-00', 1, 1, 13),
(180, 'Ana Belen', 'Gonzalez Gimenez', 5968742, '0000', '', NULL, '0000-00-00', 2, 1, 1),
(181, 'Mauricio', 'González Morra', 3976431, '0000', '', NULL, '0000-00-00', 1, 1, 16),
...
(185, 'Mateo Giulliano', 'Albrecht Cuevas', 4484570, '0000', '', NULL, '0000-00-00', 1, 1, 16),
(186, 'Erika Lujan', 'Alcaraz Gutierrez', 4814234, '0000', '', NULL, '0000-00-00', 2, 1, 1),
(187, 'Gabriel Celso', 'Almada Madelaire', 3632889, '0000', '', NULL, '0000-00-00', 1, 3, 1),
(188, 'Jose Domingo', 'Almada Martinez', 4365566, '0000', '', NULL, '0000-00-00', 1, 1, 16),
(189, 'Fernando Adrian', 'Alvarez Arzamendia', 5291512, '0000', '', NULL, '0000-00-00', 1, 1, 14),
(190, 'Oscar Alexander', 'Amarilla Leguizamón', 6129422, '0000', '', NULL, '0000-00-00', 1, 1, 1),
(191, 'Cesar David', 'Araujo Aquino', 4811633, '0000', '', NULL, '0000-00-00', 1, 1, 13),
(192, 'Luis Fernando', 'Armoa Franco', 5962948, '0000', '', NULL, '0000-00-00', 1, 1, 12),
(193, 'Lizz Stefany', 'Bareiro López', 5210405, '0000', '', NULL, '0000-00-00', 1, 1, 1),
(194, 'Silvia Alejandra', 'Barrientos', 4590128, '0000', '', NULL, '0000-00-00', 2, 1, 1),
(195, 'Nicolás Daniel', 'Benítez Aquino', 4989370, '0000', '', NULL, '0000-00-00', 1, 1, 14),
(196, 'Silvana Guillermina ', 'Benítez Valdez', 4759951, '0000', '', NULL, '0000-00-00', 2, 1, 1),
(197, 'Juan', 'Benítez', 6759512, '0000', '', NULL, '0000-00-00', 1, 1, 13),
(198, 'Pablo Ezequiel', 'Bogado Caballero', 5104776, '0000', '', NULL, '0000-00-00', 1, 1, 1),
(199, 'Alix', 'Brizuela', 5306669, '0000', '', NULL, '0000-00-00', 2, 1, 15),
(200, 'Pablo', 'Caballero', 5170878, '0000', '', NULL, '0000-00-00', 1, 1, 16),
(201, 'Raul', 'Caballero', 4642856, '0000', '', NULL, '0000-00-00', 1, 1, 15),
(202, 'Oscar', 'Cabrera Cuevas', 6625674, '0000', '', NULL, '0000-00-00', 1, 1, 14),
(203, 'Nara Paola', 'Cáceres Vega', 5446567, '0000', '', NULL, '0000-00-00', 2, 1, 13),
(205, 'Montserrat Maria Lujan', 'Sanabria González', 4932000, '0000', '', NULL, '0000-00-00', 2, 1, 18),
(206, 'Laura ', 'Ovelar Santander ', 4006047, '0000', '', NULL, '0000-00-00', 2, 1, 18),
(207, 'Silvio David', 'Palacio Meza', 5501586, '0000', '', NULL, '0000-00-00', 1, 1, 15),
(208, 'Patricio Anahi', 'Palacios Dominguez ', 5125695, '0000', '', NULL, '0000-00-00', 2, 1, 1),
(209, 'Rafael', 'Pukall', 4045651, '0000', '', NULL, '0000-00-00', 1, 3, 1),
(210, 'Ramon ', 'Perdomo', 4237340, '0000', '', NULL, '0000-00-00', 1, 1, 16),
...
(215, 'Lorena Soledad', 'Riquelme Castro', 5207050, '0000', '', NULL, '0000-00-00', 2, 1, 1),
(216, 'Alcides Miguel ', 'Riveros Sanabria', 6004381, '0000', '', NULL, '0000-00-00', 1, 1, 15),
...
(220, 'Fernando', 'Rojas Saffi ', 5964406, '0000', '', NULL, '0000-00-00', 1, 1, 13),
(221, 'Laura Leticia ', 'Rolón Salinas ', 4591618, '0000', '', NULL, '0000-00-00', 2, 1, 1),
(222, 'Oscar Andrés ', 'Román Ramos ', 4306532, '0000', '', NULL, '0000-00-00', 1, 3, 1),
(223, 'José Gabriel ', 'Romero Narvaez ', 6240963, '0000', '', NULL, '0000-00-00', 1, 1, 12),
(224, 'Fabricio Joel ', 'Ruiz Diaz Ruiz Diaz ', 4684657, '0000', '', NULL, '0000-00-00', 1, 1, 1),
(225, 'Matias Enrique ', 'Rivero Mendoza ', 4445677, '0000', '', NULL, '0000-00-00', 1, 1, 15),
(226, 'Maria José', 'Rejala Cristaldo', 6255946, '0000', '', NULL, '0000-00-00', 2, 1, 1),
(227, 'Maria del Carmen', 'Resquín Rodriguez ', 5539132, '0000', '', NULL, '0000-00-00', 2, 1, 1),
(228, 'Krause', 'Hans', 4275220, '0000', '', NULL, '0000-00-00', 1, 1, 16),
(230, 'Yamila Maria', 'Lopez Gonzalez', 4556024, '0000', '', NULL, '0000-00-00', 2, 1, 15),
(231, 'Laine Alexandra Celeste', 'Lezcano Almeida', 5064339, '0000', '', NULL, '0000-00-00', 2, 1, 15),
(232, 'Ayelen Abigail', 'Lopez Oddone', 4630569, '0000', '', NULL, '0000-00-00', 2, 1, 18),
(233, 'Andres Darío', 'Maciel Leguizamón', 4577992, '0000', '', NULL, '0000-00-00', 1, 1, 14),
(234, 'Willy Alexis ', 'Maciel Salinas', 4789023, '0000', '', NULL, '0000-00-00', 1, 1, 13),
(235, 'Cris Celia', 'Martínez Cáceres', 5494699, '0000', '', NULL, '0000-00-00', 2, 1, 1),
(236, 'Walter Sebastian', 'Martinez Leon', 4513073, '0000', '', NULL, '0000-00-00', 1, 1, 15),
...
(243, 'Alicia Ester', 'Ortiz Melgarejo', 5004240, '0000', '', NULL, '0000-00-00', 2, 1, 1),
(244, 'Alexis Moises', 'Ortiz Olmedo', 6249002, '0000', '', NULL, '0000-00-00', 1, 1, 1),
(245, 'Carmen Raquel', 'Ortiz Rotela', 4858419, '0000', '', NULL, '0000-00-00', 2, 1, 15),
(246, 'Nerea', 'Ortiz', 4317946, '0000', '', NULL, '0000-00-00', 2, 1, 16),
(247, 'Sandra Magaly', 'Cano Soria', 3529362, '0000', '', NULL, '0000-00-00', 2, 1, 18),
(248, 'Nestor Dorlan', 'Cantero Acosta', 5693789, '0000', '', NULL, '0000-00-00', 1, 1, 14),
(249, 'Gabriela Johana', 'Cardozo Villalba', 5446269, '0000', '', NULL, '0000-00-00', 2, 1, 19),
...
(253, 'Gabriela Isaura', 'Coronel Gaona', 5343489, '0000', '', NULL, '0000-00-00', 2, 1, 18),
(254, 'Luis Enrique', 'Cubilla Añazco', 3450452, '0000', '', NULL, '0000-00-00', 1, 1, 16),
(255, 'Juan José', 'Delvalle Santacruz', 4799829, '0000', '', NULL, '0000-00-00', 1, 1, 11),
(256, 'Romina Elizabeth', 'Duarte Cristaldo', 6038536, '0000', '', NULL, '0000-00-00', 2, 1, 12),
(257, 'César Andrés', 'Escobar Reinalk', 4945346, '0000', '', NULL, '0000-00-00', 1, 1, 15),
...
(260, 'María Belén', 'Espinola Vera', 5626427, '0000', '', NULL, '0000-00-00', 2, 1, 12),
(261, 'Mónica', 'Fernández Velázquez', 3812855, '0000', '', NULL, '0000-00-00', 2, 1, 13),
(262, 'Soledad Edith', 'Ferreira Gonzalez', 5457440, '0000', '', NULL, '0000-00-00', 2, 1, 13),
(263, 'Marcos Alejandro', 'Figueredo Gaona', 4815455, '0000', '', NULL, '0000-00-00', 1, 1, 14),
(264, 'Mathias Gaspar', 'Galeano Alvarez', 5690477, '0000', '', NULL, '0000-00-00', 1, 1, 15),
(265, 'Nestor Gabriel', 'Galeano Arena', 5672226, '0000', '', NULL, '0000-00-00', 1, 1, 15),
(266, 'Luis', 'Galeano', 4258408, '0000', '', NULL, '0000-00-00', 1, 1, 15),
...
(269, 'Maria Isabel', 'Segovia Mendoza', 4890928, '0000', '', NULL, '0000-00-00', 2, 1, 17),
(270, 'Andrea Araceli ', 'Silva Rudas', 4372705, '0000', '', NULL, '0000-00-00', 2, 1, 19),
(271, 'Claudia Lorena', 'Silva Salas', 5000582, '0000', '', NULL, '0000-00-00', 2, 1, 17),
...
(275, 'Alberto', 'Valdez', 5031168, '0000', '', NULL, '0000-00-00', 1, 1, 1),
(276, 'Fátima Magalí', 'Vázquez Garay', 5297665, '0000', '', NULL, '0000-00-00', 2, 1, 1),
(277, 'Daniel Josué', 'Vera Cabrera', 5065548, '0000', '', NULL, '0000-00-00', 1, 1, 15),
...
(280, 'Sherley Patricia ', 'Zarate Meza', 4801046, '0000', '', NULL, '0000-00-00', 2, 3, 19),
(281, 'Ranulfo De Jesús', 'Benítez Benitez ', 5499924, '0000', '', NULL, '0000-00-00', 1, 1, 1),
(282, 'Iván Alejandro', 'Medina Vallejos', 4757653, '0000', '', NULL, '0000-00-00', 1, 1, 17),
...
(286, 'María Alejandra', 'Pukall', 4325766, '0000', '', NULL, '0000-00-00', 2, 1, 14),
...
(289, 'Félix David', 'Leiva Portillo', 3618837, '0000', '', NULL, '0000-00-00', 1, 1, 15),
...
(300, 'Miguel', 'Villagra', 4580884, '0000', '', NULL, '0000-00-00', 1, 1, 1),
(301, 'Marco Aurelio', 'Acosta Posadaso', 4777842, '0000', '', NULL, '0000-00-00', 1, 1, 16),
(302, 'Bruno', 'Garcete', 5378939, '0000', '', NULL, '0000-00-00', 1, 1, 1),
(303, 'Emilio', 'Ginzo Benitez', 4710674, '0000', '', NULL, '0000-00-00', 1, 1, 16),
(304, 'Arami', 'Nuñez Scolari', 5241565, '0000', '', NULL, '0000-00-00', 2, 1, 16),
...
(307, 'Paloma', 'Fernández', 4459973, '0000', '', NULL, '0000-00-00', 2, 1, 15),
(308, 'David', 'Santacruz', 4238685, '0000', '', NULL, '0000-00-00', 1, 1, 15),
(309, 'Pepe', 'Grillo', 11111111, '0000', 'holacomoest@gmail.com', NULL, '0000-00-00', 1, 1, 1);
...
--
ALTER TABLE `asistencia`
  MODIFY `asi_codigo` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=20;
...
--
ALTER TABLE `funcion`
  MODIFY `fun_codigo` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT for table `participante`
--
ALTER TABLE `participante`
  MODIFY `par_codigo` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=297;

--
-- AUTO_INCREMENT for table `persona`
--
ALTER TABLE `persona`
  MODIFY `per_codigo` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=310;
