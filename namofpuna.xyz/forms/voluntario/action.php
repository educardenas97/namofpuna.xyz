...
if (traerCodigoPersona($per_ci)) {
  ...
  $sql="INSERT INTO persona (per_codigo,per_nombre,per_apellido,per_ci,per_password,per_correo,per_telefono,per_fecha_nac,sex_codigo,tp_codigo,car_codigo)
    VALUES (null,'$per_nombre','$per_apellido','$per_ci','$per_password','$per_correo','$per_telefono','$per_fecha_nac','$sex_codigo','$tp_codigo','$car_codigo')";
